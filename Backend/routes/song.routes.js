...
const { createSongController, roleBasedAllsongController, getAllSongController, deleteSongController, viewSongController } = require("../controllers/songs.controller");
